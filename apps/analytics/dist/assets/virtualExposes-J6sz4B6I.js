...
const exposesMap = {
      ...
      ,
        "./AnalyticsPage": async () => {
          const importModule = await __vitePreload(() => import('./AnalyticsPage-CcuOWBrc.js'),true?__vite__mapDeps([9,1,2,3,4,0,5,6,7,8]):void 0);
          const exportModule = {};
          Object.assign(exportModule, importModule);
          Object.defineProperty(exportModule, "__esModule", {
            value: true,
      ...
      ,
        "./AnalyticsApp": async () => {
          const importModule = await __vitePreload(() => import('./App-DTXsoTLU.js').then(n => n.x),true?__vite__mapDeps([10,1,2,3,4,11,6,5,7,8,0,12,9]):void 0);
          const exportModule = {};
          Object.assign(exportModule, importModule);
          Object.defineProperty(exportModule, "__esModule", {
            value: true,
